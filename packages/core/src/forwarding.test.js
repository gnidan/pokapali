...
import { createForwardingRecord, encodeForwardingRecord, decodeForwardingRecord, verifyForwardingRecord, } from "./forwarding.js";
...
describe("forwarding records", () => {
    ...
    it("encode/decode round-trip", async () => {
        const record = await createForwardingRecord("oldName", "newName", "https://example.com/doc/newName#frag", rotationKey);
...
//# sourceMappingURL=forwarding.test.js.map