...
describe("fetchBlock", () => {
    ...
    it("retries on transient failure", async () => {
        ...
        const result = await fetchBlock({ blockstore }, cid, { retries: 2, baseMs: 1, timeoutMs: 5000 });
        expect(result).toBe(block);
    ...
    it("throws after exhausting retries", async () => {
        ...
        await expect(fetchBlock({ blockstore }, cid, { retries: 1, baseMs: 1, timeoutMs: 5000 })).rejects.toThrow("gone");
    });
    describe("timeout / abort", () => {
        ...
        it("passes abort signal to blockstore.get", async () => {
            ...
            await expect(fetchBlock({ blockstore }, cid, {
                retries: 0,
                baseMs: 1,
                timeoutMs: 100,
...
//# sourceMappingURL=fetch-block.test.js.map