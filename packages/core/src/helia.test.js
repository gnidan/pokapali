...
const { mockPubsub, mockStop, mockHelia, mockCreateHelia, mockGossipsub, } = vi.hoisted(() => {
    const mockPubsub = {
        subscribe: vi.fn(),
        unsubscribe: vi.fn(),
        publish: vi.fn(),
...
import { acquireHelia, releaseHelia, getHeliaPubsub, _resetHeliaState, } from "./helia.js";
...
//# sourceMappingURL=helia.test.js.map