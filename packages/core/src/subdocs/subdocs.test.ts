...
import { Subdocs } from "./subdocs.js";
...
describe("Subdocs", () => {
  ...
  it("creates docs for each namespace", () => {
    const mgr = Subdocs.create(ipns, namespaces);
  ...
  it("skipOrigins suppresses dirty for " + "custom origins", () => {
    ...
    const mgr = Subdocs.create(ipns, namespaces, { skipOrigins: skip });
